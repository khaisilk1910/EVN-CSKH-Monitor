  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}button,select{font:inherit}.app{min-height:100vh;min-height:100dvh;background:radial-gradient(circle at 75% -15%,rgba(49,104,204,.16),transparent 30%),var(--bg);color:var(--text)}
      ...
      .chart-frame{height:clamp(220px,32vw,355px);padding:8px 2px 0;overflow:hidden}.bars{height:100%;display:grid;align-items:stretch;box-sizing:border-box}.monthly-bars{grid-template-columns:repeat(12,minmax(0,1fr));gap:clamp(2px,.7vw,10px);min-width:0;padding-inline:clamp(5px,.8vw,12px)}.month-bar-group{height:100%;display:grid;grid-template-rows:56px 1fr 22px;gap:8px;align-items:end;text-align:center;min-width:0;cursor:pointer;touch-action:manipulation;border-radius:8px;outline:none}.month-bar-group:focus-visible,.month-bar-group.tooltip-active{box-shadow:0 0 0 2px color-mix(in srgb,var(--blue) 55%,transparent)}.month-bar-values{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:clamp(2px,.28vw,5px);align-items:end;min-width:0;height:100%;padding:0 0 5px}.month-value{--label-shift:0px;font-size:clamp(7px,.7vw,10.5px);font-weight:650;white-space:nowrap;overflow:visible;text-overflow:clip;min-width:0;align-self:end;justify-self:center;transform:translateX(var(--label-shift)) rotate(-48deg);transform-origin:50% 100%;line-height:1}.month-bar-group:first-child .month-value{--label-shift:5px}.month-bar-group:last-child .month-value{--label-shift:-5px}.kwh-value{color:#9dc8ff}.cost-value{color:#ffd18a}.month-bar-tracks{position:relative;height:100%;min-height:125px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:clamp(2px,.32vw,6px);align-items:stretch;border-bottom:1px solid var(--line);min-width:0}.month-bar-tracks:before{content:"";position:absolute;inset:0 0 auto;height:1px;background:linear-gradient(90deg,transparent,var(--line),transparent);opacity:.45}.series-track{height:100%;min-width:0;display:flex;align-items:flex-end;justify-content:center}.series-bar{height:var(--bar-height);width:min(82%,32px);min-width:3px;border-radius:8px 8px 3px 3px;animation:growbar .55s cubic-bezier(.2,.8,.2,1) both;transform-origin:bottom;box-shadow:inset 0 1px 0 rgba(255,255,255,.22)}.kwh-bar{background:linear-gradient(180deg,#65b0ff 0%,#4388ff 38%,#2457e6 100%);box-shadow:0 8px 18px rgba(37,87,230,.22),inset 0 1px 0 rgba(255,255,255,.24)}.cost-bar{background:linear-gradient(180deg,#ffd477 0%,#ffb342 42%,#e88a18 100%);box-shadow:0 8px 18px rgba(232,138,24,.2),inset 0 1px 0 rgba(255,255,255,.24)}.series-bar.missing-series{height:0;min-height:0;background:transparent;box-shadow:none}.month-bar-group:hover .series-bar{filter:brightness(1.1)}.daily-bars{grid-template-columns:repeat(var(--day-count,31),minmax(3px,1fr));gap:clamp(1px,.35vw,5px);min-width:0;padding-inline:clamp(5px,.8vw,10px)}.bar-col{height:100%;display:grid;grid-template-rows:40px 1fr 22px;gap:8px;align-items:end;text-align:center;min-width:0}.bar-value{--label-shift:0px;font-size:clamp(7px,.78vw,10.5px);color:#b8c7dc;white-space:nowrap;overflow:visible;text-overflow:clip;min-width:0;align-self:end;justify-self:center;transform:translateX(var(--label-shift)) rotate(-48deg);transform-origin:50% 100%;line-height:1;padding-bottom:4px}.bar-col:first-child .bar-value{--label-shift:5px}.bar-col:last-child .bar-value{--label-shift:-5px}.bar-track{position:relative;height:100%;min-height:125px;display:flex;align-items:flex-end;justify-content:center;border-bottom:1px solid var(--line)}.bar-track:before{content:"";position:absolute;inset:0 0 auto;height:1px;background:linear-gradient(90deg,transparent,var(--line),transparent);opacity:.45}.bar{height:var(--bar-height);width:min(68%,46px);min-width:4px;border-radius:9px 9px 3px 3px;background:linear-gradient(180deg,#65b0ff 0%,#4388ff 38%,#2457e6 100%);box-shadow:0 8px 20px rgba(37,87,230,.25),inset 0 1px 0 rgba(255,255,255,.24);animation:growbar .55s cubic-bezier(.2,.8,.2,1) both;transform-origin:bottom}.day-bar-col .bar{width:72%;border-radius:6px 6px 2px 2px}.bar-col.missing .bar{background:color-mix(in srgb,var(--muted) 12%,transparent);box-shadow:none}.bar-label{font-size:clamp(8px,.9vw,11px);color:var(--muted);align-self:start}.quiet-label{opacity:.3}.bar-col:hover .bar{filter:brightness(1.12)}.daily-chart-frame{height:clamp(225px,29vw,330px)}
      .five-year-chart-frame{height:clamp(250px,30vw,360px)}.five-year-bars{grid-template-columns:repeat(var(--year-count,5),minmax(0,1fr));gap:clamp(8px,2.2vw,38px);min-width:0;padding-inline:clamp(8px,1vw,14px)}.five-year-bar-group{height:100%;display:grid;grid-template-rows:62px 1fr 28px;gap:9px;align-items:end;text-align:center;min-width:0;cursor:pointer;touch-action:manipulation;border-radius:9px;outline:none}.five-year-bar-group:focus-visible,.five-year-bar-group.tooltip-active{box-shadow:0 0 0 2px color-mix(in srgb,var(--blue) 55%,transparent)}.five-year-values{height:100%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:clamp(3px,.5vw,8px);align-items:end;padding:0 0 5px;min-width:0}.five-year-value{--label-shift:0px;font-size:clamp(7.5px,.85vw,11px);font-weight:700;white-space:nowrap;overflow:visible;justify-self:center;transform:translateX(var(--label-shift)) rotate(-42deg);transform-origin:50% 100%;line-height:1}.five-year-bar-group:first-child .five-year-value{--label-shift:8px}.five-year-bar-group:last-child .five-year-value{--label-shift:-8px}.five-year-tracks{position:relative;height:100%;min-height:145px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:clamp(4px,.8vw,12px);align-items:stretch;border-bottom:1px solid var(--line);min-width:0}.five-year-tracks:before{content:"";position:absolute;inset:0 0 auto;height:1px;background:linear-gradient(90deg,transparent,var(--line),transparent);opacity:.42}.five-year-bar{width:min(76%,58px);min-width:8px;border-radius:9px 9px 3px 3px}.five-year-label{align-self:start;font-size:clamp(11px,1.15vw,14px);color:#c9d8ef}.five-year-bar-group:hover .series-bar{filter:brightness(1.1)}.chart-empty{grid-column:1/-1;display:grid;place-items:center;color:var(--muted);font-size:12px;border:1px dashed var(--line);border-radius:12px;min-height:180px}
      ...
      @media(max-width:760px){.brand p{white-space:normal}.month-head{align-items:flex-start;flex-direction:column}.period-controls{width:100%;grid-template-columns:repeat(2,minmax(0,1fr))}.panel-head p{max-width:68ch}.stats-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.stat-average{grid-column:1/-1}.outage-alert-head{align-items:flex-start}.month-bar-group{grid-template-rows:52px 1fr 20px;gap:5px}.month-value{transform:translateX(var(--label-shift)) rotate(-56deg);font-size:6.8px}.series-bar{width:86%}.bar-col{grid-template-rows:38px 1fr 22px;gap:5px}.bar-value{font-size:6.8px;transform:translateX(var(--label-shift)) rotate(-56deg)}.five-year-bar-group{grid-template-rows:58px 1fr 24px;gap:5px}.five-year-value{font-size:6.8px;transform:translateX(var(--label-shift)) rotate(-53deg)}.five-year-tracks{gap:4px}.five-year-bar{width:82%;min-width:5px}}
      @media(max-width:520px){.topbar-inner{padding:12px 10px;gap:12px}.brand{gap:10px}.brand img{width:50px;height:50px;border-radius:15px}.brand h1{font-size:21px}.brand p{font-size:11px;line-height:1.35}.toolbar{grid-template-columns:1fr 1fr}.reload-btn{grid-column:1/-1;height:40px}.control select{height:40px;padding:0 9px}.control>span{font-size:10px}main{padding:10px}.status-row{gap:7px}.customer-meta{width:100%}.metric-grid{gap:8px}.metric{padding:11px;gap:8px;min-height:92px}.metric-icon{width:34px;height:34px;border-radius:10px}.metric strong{font-size:17px}.metric span{font-size:11px}.metric small{font-size:10px}.panel{padding:11px;border-radius:15px}.outage-alert{border-radius:15px;padding:11px}.outage-bolt{width:40px;height:40px}.outage-alert-head{margin-bottom:9px}.outage-item{padding:9px}.stats-grid{gap:6px}.stat-card{padding:9px}.five-year-summary{grid-template-columns:1fr;gap:6px}.chart-frame{height:266px}.daily-chart-frame{height:248px}.five-year-chart-frame{height:278px}.year-chart-legend{gap:6px 10px;font-size:10px}.monthly-bars{gap:2px;padding-inline:9px}.month-bar-group{grid-template-rows:48px 1fr 18px;gap:4px}.month-bar-values{gap:1px;padding-bottom:2px}.month-value{font-size:6.1px;transform:translateX(var(--label-shift)) rotate(-60deg)}.month-bar-group:first-child .month-value{--label-shift:8px}.month-bar-group:last-child .month-value{--label-shift:-8px}.month-bar-tracks{gap:2px;min-height:110px}.series-bar{width:90%;min-width:2px;border-radius:5px 5px 2px 2px}.daily-bars{gap:1px;padding-inline:8px}.bar-col{grid-template-rows:32px 1fr 18px;gap:4px}.bar-value{font-size:6px;transform:translateX(var(--label-shift)) rotate(-58deg);padding-bottom:2px}.bar-col:first-child .bar-value{--label-shift:7px}.bar-col:last-child .bar-value{--label-shift:-7px}.bar-label{font-size:8px}.bar{width:72%;min-width:3px;border-radius:6px 6px 2px 2px}.five-year-bars{gap:5px;padding-inline:12px}.five-year-bar-group{grid-template-rows:54px 1fr 22px;gap:4px}.five-year-values{gap:1px;padding-bottom:2px}.five-year-value{font-size:6.2px;transform:translateX(var(--label-shift)) rotate(-56deg)}.five-year-bar-group:first-child .five-year-value{--label-shift:10px}.five-year-bar-group:last-child .five-year-value{--label-shift:-10px}.five-year-tracks{gap:2px;min-height:120px}.five-year-bar{width:88%;min-width:3px;border-radius:6px 6px 2px 2px}.five-year-label{font-size:10px}th,td{padding:9px 6px;font-size:11px}.daily-table th:nth-child(1){width:25%}.daily-table th:nth-child(2){width:38%}.daily-table th:nth-child(3){width:37%}.daily-table td:first-child strong{min-width:28px;height:26px}.year-badge{min-width:52px;padding:5px 8px}.panel-head h2{font-size:17px}.panel-head p{font-size:11px}.period-controls{gap:6px}.mini-control select{height:38px;padding:0 8px}.chart-tooltip{font-size:11.5px;padding:8px 10px}}
      @media(max-width:360px){.brand h1{font-size:19px}.metric-grid{grid-template-columns:1fr}.metric{min-height:80px}.stats-grid{grid-template-columns:1fr}.stat-average{grid-column:auto}.chart-frame{height:258px}.daily-chart-frame{height:242px}.five-year-chart-frame{height:272px}.monthly-bars{padding-inline:10px}.month-bar-group{grid-template-rows:50px 1fr 18px;gap:3px}.month-value{font-size:5.8px;transform:translateX(var(--label-shift)) rotate(-62deg)}.month-bar-group:first-child .month-value{--label-shift:9px}.month-bar-group:last-child .month-value{--label-shift:-9px}.month-bar-tracks{min-height:105px}.daily-bars{padding-inline:9px}.bar-col{grid-template-rows:34px 1fr 18px;gap:3px}.bar-value{font-size:5.7px;transform:translateX(var(--label-shift)) rotate(-60deg)}.bar-col:first-child .bar-value{--label-shift:8px}.bar-col:last-child .bar-value{--label-shift:-8px}.five-year-bars{padding-inline:13px}.five-year-bar-group{grid-template-rows:58px 1fr 20px;gap:3px}.five-year-value{font-size:5.8px;transform:translateX(var(--label-shift)) rotate(-58deg)}.five-year-bar-group:first-child .five-year-value{--label-shift:11px}.five-year-bar-group:last-child .five-year-value{--label-shift:-11px}.five-year-tracks{min-height:115px}.five-year-label{font-size:9px}th,td{font-size:10.5px;padding:8px 4px}.outage-count{display:none}}
