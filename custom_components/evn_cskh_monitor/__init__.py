...
from .debt_fix import install_debt_fix
...
# Install the debt hotfix before any config-entry runtime objects are created.
# This keeps invoice-history persistence and current-debt persistence separate.
install_debt_fix()
